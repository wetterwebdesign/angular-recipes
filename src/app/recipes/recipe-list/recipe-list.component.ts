...
export class RecipeListComponent implements OnInit {
  recipes: Recipe[] = [
    ...
    new Recipe('Test Recipe', 'this is a test', 'https://cdn.vox-cdn.com/thumbor/gcLdEduI29mEc9RhG7_l9GDaZb4=/0x0:844x844/1200x800/filters:focal(355x355:489x489)/cdn.vox-cdn.com/uploads/chorus_image/image/54896147/bud_and_marilyns.0.jpg')
  ];
